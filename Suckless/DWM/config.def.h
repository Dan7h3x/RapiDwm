...
static const int bar_height =
    24; /* 0 means derive from font, >= 1 explicit height */
...
static const unsigned int tabposy =
    2; /* tab position on Y axis, 0 = top, 1 = center, 2 = bottom */
...
#if BAR_PANGO_PATCH
static const char font[] = {"CaskaydiaCove Nerd Font:size=14"};
#else
...
static const char *layoutmenu_cmd = "layout.sh";
#endif
...
#if RENAMED_SCRATCHPADS_PATCH
const char *spcmd1[] = {"s",  "alacritty",  "--class", "'Float'",
                        "-T", "ScratchPad", NULL};
const char *spmusic[] = {"m",  "alacritty", "--class", "'FloatMusic'",
                         "-T", "Music",     "-e",      "ncmpcpp",
                         NULL};
const char *spproc[] = {"b",       "alacritty", "--class", "'FloatProc'", "-T",
                        "Process", "-e",        "btop",    NULL};
const char *spfile[] = {"f", "fsearch", NULL};

#elif SCRATCHPADS_PATCH
const char *spcmd1[] = {"alacritty", "--class",    "'Float'",
                        "-T",        "ScratchPad", NULL};
const char *spmusic[] = {"alacritty", "--class", "'FloatMusic'", "-T",
                         "Music",     "-e",      "ncmpcpp",      NULL};
            ...
            RULE(.class = "Matlab",
                ...
                RULE(.class = "python3",
                    ...
                    RULE(.class = "matplotlib",
                         .isfloating = 1) RULE(.class = "Python3",
                                               .isfloating =
                                                   1) RULE(.class = "Figure",
                                                           .isfloating = 1)
                        RULE(.class = "Lxappearance",
                             .isfloating = 1) RULE(.class = "TelegramDesktop",
                                                   .isfloating = 1)
                            RULE(.class = "Pavucontrol", .isfloating = 1)
                                RULE(.class = "Blueman-manager",
                                     .isfloating = 1) RULE(.class =
                                                               "Windscribe2",
                                                           .isfloating = 1)
                                    RULE(.class = "Goodvibes", .isfloating = 1)
                                        ...
                                        RULE(.instance = "Float",
                                            ...
                                            RULE(.instance = "FloatMusic",
                                                 .scratchkey = 'm',
                                                 .isfloating = 1)
                                                RULE(.instance = "FloatProc",
                                                     .scratchkey = 'b',
                                                     .isfloating = 1)
...
static const char *dmenucmd[] = {"dmenu_run",
                                 ...
                                 NULL};
static const char *termcmd[] = {"alacritty", "-T",    "Float",
                                "--class",   "Float", NULL};
 ...
 */
    ...
    {MODKEY | Mod1Mask, XK_Down, moveresize, {.v = "0x 0y 0w 25h"}},
    {MODKEY | Mod1Mask, XK_Up, moveresize, {.v = "0x 0y 0w -25h"}},
    {MODKEY | Mod1Mask, XK_Right, moveresize, {.v = "0x 0y 25w 0h"}},
    {MODKEY | Mod1Mask, XK_Left, moveresize, {.v = "0x 0y -25w 0h"}},
    ...
    {MODKEY | ShiftMask | ControlMask,
     ...
     {.v = &default_inset}},
#endif // INSETS_PATCH
    {MODKEY | ShiftMask, XK_KP_Right, zoom, {0}},
#if VANITYGAPS_PATCH
    ...
    {MODKEY, XK_d, setlayout, {.v = &layouts[8]}},
    ...
    {Mod1Mask, XK_m, togglescratch, {.v = spmusic}},
    {Mod1Mask, XK_b, togglescratch, {.v = spproc}},
    {Mod1Mask, XK_f, togglescratch, {.v = spfile}},
    {MODKEY | ControlMask, XK_grave, setscratch, {.v = spcmd1}},
    {MODKEY | ShiftMask, XK_grave, removescratch, {.v = spcmd1}},
#elif SCRATCHPADS_PATCH
    {MODKEY, XK_grave, togglescratch, {.ui = 0}},
    {Mod1Mask, XK_m, togglescratch, {.ui = 1}},
